...
config :shard_hound, ShardHoundWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "OFxcbSMZPEz1vswwPAy892mT7ZdMPLqPMS1lRuXQqKEYRytApkjppGSnfOk2+DfB",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:shard_hound, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:shard_hound, ~w(--watch)]}
  ]
...
config :shard_hound, dev_routes: true
